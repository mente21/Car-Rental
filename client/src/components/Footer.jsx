    ...
    >
      ...
      >
        <div>
          ...
          >
            Premium car rental servive wth a wide selection of luxury and every
            day vehicles for all your driving needs.
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
      ...
      >
        <p>@ {new Date().getFullYear()} Mente's Car Rental. All rights reserved.</p>
