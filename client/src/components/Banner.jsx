  ...
  return (
    ...
    >
      <div className="text-white">
        ...
        <p className="mt-2">
          Monitize your vehicle effortlessly by listing it on carRental.
        </p>
        <p className="max-w-130">
          We take care of insurance, drivers verification and secure payments so
          you cann earn passive income, stress-free.
        </p>
        <motion.button
