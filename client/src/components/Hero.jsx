  ...
  return (
    ...
    >
      <motion.h1
        ...
        className="text-4xl md:text-5xl font-semibold mt-20 md:mt-24"
      >
        Luxury cars on rent
      </motion.h1>
      <motion.form
      ...
      md:items-center justify-between p-6 rounded-lg md:rounded-full w-full max-w-80 md:max-w-200
