...
const AddCar = () => {
  ...
  return (
    <div className="px-4 py-10 md:px-10 flex-1">
      ...
      including pricing, availiability, and car spesifacation."
      />
      <form
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col w-full">
            ...
            <input
              type="text"
              placeholder="e.g BMG, Mercides,Audi....."
              required
        ...
        <div className="flex flex-col w-full">
          ...
          >
            ...
            <option value="Houstin">Houstin</option>
        ...
        <div className="flex flex-col w-full">
          ...
          <textarea
            rows={5}
            placeholder="eg. A luxuray SUv with powerfull engine"
            required
            className="px-3 py-2 mt-1 border border-borderColor rounded-md
        outline-none"
